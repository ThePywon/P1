...
impl ComponentManager {
  ...
  pub fn get_container_from_id(&self, c_id: &TypeId) -> Option<Ref<'_, TypeId, ErasedMapContainer<u32>>> {
    self.0.get(c_id)
  }
  pub fn get_container_mut<C: Component>(&self) -> Option<RefMut<'_, TypeId, ErasedMapContainer<u32>>> {
    self.get_container_mut_from_id(&TypeId::of::<C>())
  }
  pub fn get_container_mut_from_id(&self, c_id: &TypeId) -> Option<RefMut<'_, TypeId, ErasedMapContainer<u32>>> {
    self.0.get_mut(c_id)
  }
